...
//                         <div className="lg:w-4/5 w-full bg-white mx-auto flex flex-col lg:flex-row shadow-lg rounded-lg p-6">
//                             {/* Left Section */}
...
//                                         ${data.price}
//                                     </span>
//                                     <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-4 lg:px-6 focus:outline-none hover:bg-indigo-600 rounded">
//                                         Add to Cart
//                                     </button>
//                                 </div>
//                             </div>
...
//                                 <Image
//                                     alt="ecommerce"
//                                     className="object-contain rounded-lg shadow-md lg:h-auto h-64"
//                                     src={data.thumbnail}
